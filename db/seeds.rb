...
user6 = User.create!(first_name:"Chanse", last_name:"Campbell", mobile:"07920201985", email:"chanse@campbell.com", postcode: "SW15 3NR", address_1:"Flat 12, St Ronans", address_2:"63-65, Putney Hill", city: "London", is_admin: false, profile_pic: File.open(Rails.root.to_s + "/db/seeds_images/chanse.png") , password:"password")
...
event3 = Event.create!(name:"Fez", date: DateTime.new(2016,8,15), description:"The long weekend is here and where better to bring your party ......Our legendary dance floor will be jumping to all the latest dance floor fillers and classic tracks", allocation: 130, brand_logo: File.open(Rails.root.to_s + "/db/seeds_images/fez.png"), user_id: 1)

event4 = Event.create!(name:"Infernos", date: DateTime.new(2016,9,12), description:"Filthy, dirty hole in Clapham invites you to spend £10 per jagerbomb and listen to sclub on repeat. Enjoy middle class working types in their twenties trying to take themselves back to University.", allocation: 150, brand_logo: File.open(Rails.root.to_s + "/db/seeds_images/infernos.jpg"), user_id: 1)

event5 = Event.create!(name:"Oslo", date: DateTime.new(2016,9,15), description:"Each and every Friday night, Valhalla brings you London’s best party DJs playing strictly party music: Hip-Hop, R&B, Garage, Guilty Pleasures, House, Funk, Disco & more!", allocation: 50, brand_logo: File.open(Rails.root.to_s + "/db/seeds_images/oslo.png"), user_id: 1)